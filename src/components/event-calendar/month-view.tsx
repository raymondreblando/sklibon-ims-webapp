          ...
          >
            {week.map((day, dayIndex) => {
              ...
              return (
                <div
                  key={day.toString()}
                  className="group border-border/70 data-outside-cell:bg-muted/10 data-outside-cell:text-muted-foreground/50 border-r border-b p-1 last:border-r-0 hover:bg-background-muted/50 transition-colors"
                ...
                >
                  ...
                  >
                    <div className="group-data-today:bg-primary group-data-today:text-primary-foreground mt-1 inline-flex size-6 items-center justify-center rounded-full text-sm font-medium">
                      {format(day, "d")}
                    </div>
                    <div
