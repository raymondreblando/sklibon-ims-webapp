...
export const UpdateEventForm = () => {
  const { form, onSubmit } = useUpdateEventForm();
  ...
  return (
    ...
    >
      <FormCheckbox
        ...
        label="Open event attedance"
        item={{
          id: "true",
          label: "Open Attendance",
          description:
            "This event will be open for all participants who wish to attend.",
        }}
      ...
      />
      <FormInput name="venue" label="Event venue" />
      <FormField
        control={form.control}
